<script module lang="ts">
  ...
  // A key, for the fields that take a secret. Bit on the right, ring on the
  // left, on the same 24px grid as the rest.
  paths.key = "M14.5 9.5a3.5 3.5 0 1 1 3.5 3.5c-.5 0-1-.1-1.4-.3L15 14.3V16h-2v2h-2v2H8v-2.6l5.8-5.8c-.2-.4-.3-.9-.3-1.4ZM18 8.6h.01";
